...
class ImportStation extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'app:importstation';
     ...
     * @var string
     */
    protected $description = 'Import Stations';
    ...
    public function handle()
    {
        ...
        for ($i=0; $i < count($stations); $i++) { 
            Station::create([
                'name' => $stations[$i],
                'quanpin' => str_replace('-', '', $pinyin->permalink($stations[$i])),
                'jianpin' => $pinyin->abbr($stations[$i])
            ]);
        }
    }
}
